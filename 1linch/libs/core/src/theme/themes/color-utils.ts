...
const _rainbowRandomColorsInterpolate = interpolateColorArray(
  rainbowColors,
  rainbowColors.length / 2
)
export const rainbowRandomColorsInterpolate = [
  ..._rainbowRandomColorsInterpolate,
  ..._rainbowRandomColorsInterpolate.reverse(),
]
...
export function interpolateColorRange(
