import { AnimationMapController } from '@1inch-community/core/lit-utils'
...
export abstract class NotificationAnimationMapBaseController
  implements AnimationMapController<[string, NotificationRecord], void, void, number>
{
  ...
  async onBeforeAnimation(
    ...
    removeElements: Map<number, HTMLElement>,
