import { getMobileMatchMediaEmitter, subscribe } from '@1inch-community/core/lit-utils'
...
export abstract class NotificationsBaseContainerElement
  extends LitElement
  implements NotificationsContainer
{
  ...
  makeNotificationTemplate(record: NotificationRecord) {
    ...
    return html` <div class="notification-template">${template}</div> `
  }
