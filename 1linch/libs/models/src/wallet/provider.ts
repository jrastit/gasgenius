import { Address, ProviderConnectInfo, ProviderMessage, ProviderRpcError } from 'viem'
...
export type EthereumProvider = {
  ...
  isTrust?: true
  isConnected?: () => boolean
  _metamask?: EthereumProviderMetamaskLike
}

export type EthereumProviderMetamaskLike = {
  isUnlocked: () => boolean
}
